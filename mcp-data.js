...
{name:"filesystem",cat:"办公",desc:"本地文件读写",config:{"command":"npx","args":["-y","@modelcontextprotocol/server-filesystem","/home"]}},
{name:"memory",cat:"办公",desc:"持久化知识记忆(免费)",config:{"command":"npx","args":["-y","@modelcontextprotocol/server-memory"]}},
{name:"sqlite",cat:"办公",desc:"SQLite 数据库",config:{"command":"npx","args":["-y","@modelcontextprotocol/server-sqlite","--db-path","./data.db"]}},
...
{name:"notion",cat:"办公",desc:"Notion 笔记操作",config:{"command":"npx","args":["-y","@notionhq/notion-mcp-server"],"env":{"NOTION_API_KEY":"YOUR_TOKEN"}}},
{name:"redis",cat:"开发",desc:"Redis 缓存操作",config:{"command":"npx","args":["-y","@modelcontextprotocol/server-redis"],"env":{"REDIS_URL":"redis://localhost:6379"}}},
{name:"email",cat:"通讯",desc:"SMTP 邮件收发",config:{"command":"npx","args":["-y","@modelcontextprotocol/server-email"],"env":{"SMTP_HOST":"smtp.gmail.com","SMTP_PORT":"587","EMAIL_USER":"YOUR_EMAIL","EMAIL_PASS":"YOUR_PASS"}}}
];